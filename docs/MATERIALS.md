...
| **Amplifier** | MAX98357A I²S class-D, 3-pack — [B0CDWXZZCH](https://www.amazon.com/dp/B0CDWXZZCH) (HiLetgo) | $9.49 / 3 | ✅ Adafruit-lineage clone, 2.5–5.5 V — runs from the raw cell rail. Stock SD ≈ 0.30 V = (L+R)/2 mono mix at **full amplitude** (see the [amplifier lesson](../edu/fundamentals/10-class-d-btl-speakers-and-acoustics.md)). Or genuine Adafruit [#3006](https://www.adafruit.com/product/3006) |
...
## 2 · Power — the R1 chain (read the durable [power-integrity lesson](../edu/fundamentals/06-li-ion-power-integrity-decoupling-uvlo-thermal.md))
