...
| --- | --- | --- | --- |
| [Scope Countdown](https://claude.ai/artifact/8w8pHPXT93Y3jmfXRspfbq) | [`DAILY_STUDY_AND_LAB_PLAN.md`](../plan/DAILY_STUDY_AND_LAB_PLAN.md), [`fundamentals/README.md`](fundamentals/README.md), the promotion gates | Concept week, 22–30 September 2026: two illustrated lessons a day with the bench optional, a review day, and the DHO802's first three captures on arrival | 2026-09-21, revised the same day |
