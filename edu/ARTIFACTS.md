...
| --- | --- | --- | --- |
| [Scope Countdown](https://claude.ai/artifact/8w8pHPXT93Y3jmfXRspfbq) | [`DAILY_STUDY_AND_LAB_PLAN.md`](../plan/DAILY_STUDY_AND_LAB_PLAN.md), [`fundamentals/README.md`](fundamentals/README.md), the promotion gates | 22–30 September 2026: two illustrated lessons in two hours plus one build hour every day; Wednesday 23's build hour takes Step 11 to a spoken reply without the scope, by builder decision; the other build hours are the speaker lab, a batch radio survey, the dummy load, measuring parts, scope prep, and two open hours, then the DHO802's first captures | 2026-09-21, revised 2026-09-22 |
...
| [First Sound Build Hour](https://claude.ai/artifact/SeJ5R6L42yetQFQMsAXTWR) | [`plan/FAST_TRACK.md`](../plan/FAST_TRACK.md), Step 11 and its prototype shortcut; the MAX98357A datasheet | One-hour build session to make A1 speak: solder and wire the amplifier, PASS 11A on the pull-down alone, flash the prebuilt speaking image, provision Wi-Fi, connect the speaker at volume cap 15, and PASS 11C with 11B skipped by builder decision; nine diagrams, including the cap-15 voltage margin, the wiring map, the breadboard close-up and the SD threshold ladder | 2026-09-22 |
| [Build Hour Wednesday](https://claude.ai/artifact/Skc4nBjeVXUN9yRnUL4WXg) | the Scope Countdown's Wednesday 23 build hour, fast-track Steps 10 and 11, the lab record template | One-hour build session: read A1's saved Wi-Fi from flash, meter whether USB reaches the 5V pin directly or through a diode, write STEP10-01 and VBUS-01; timeline, flash-read data flow and meter-setup diagrams | 2026-09-22 |
| [Pocket AI Step 11](https://claude.ai/artifact/6bXhKLGEztiB1Z9zWkGJ4U) | [`plan/FAST_TRACK.md`](../plan/FAST_TRACK.md), Step 11 | Bench guide for the USB-powered speaker with owned parts only: why one supply removes the translator, the wiring, choosing the SD pull-down, the kit-resistor dummy load, three pass gates, and the builder's cap-15 shortcut | 2026-09-21, shortcut note 2026-09-22 |
